...
Despues de esto ya funciona, solo hace falta setear la informacion para que el IPN acceda al server desde internet, en el tutorial usan NGROK para crear una IP fija en local, yo levantare una instancia temporal de AWS o Codenvy para que sea mas realista
...
AL CREARLAS POR DEFAULT LAS PONE EN FALSE Y YA PAGADAS CAMBIA A TRUE ese es el workflow de las eshops
